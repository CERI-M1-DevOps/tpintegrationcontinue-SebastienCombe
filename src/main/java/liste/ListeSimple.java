...
public class ListeSimple {
    ...
    /**
     * Retourne la taille actuelle de la liste (nombre d'éléments).
     * @return Nombre d'éléments présents dans la liste
     */
    public long getSize() {
        return size;
    }
     ...
     * @param element valeur entière à insérer en tête
     */
